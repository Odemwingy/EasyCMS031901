...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        DB::transaction(function (): void {
            ...
            $menuGroups = [
                ['parent_id' => null, 'type' => 1, 'name' => '后台管理', 'permission' => 'admin:dashboard:view', 'route_path' => null, 'component' => null, 'icon' => 'Shield', 'sort' => 1],
                ['parent_permission' => 'admin:dashboard:view', 'type' => 2, 'name' => '用户管理', 'permission' => 'admin:users:list', 'route_path' => '/admin/users', 'component' => 'features/users/UserListPage', 'icon' => 'Users', 'sort' => 10],
                ['parent_permission' => 'admin:users:list', 'type' => 3, 'name' => '新建用户', 'permission' => 'admin:users:create', 'route_path' => null, 'component' => null, 'icon' => null, 'sort' => 11],
                ['parent_permission' => 'admin:users:list', 'type' => 3, 'name' => '编辑用户', 'permission' => 'admin:users:edit', 'route_path' => null, 'component' => null, 'icon' => null, 'sort' => 12],
                ['parent_permission' => 'admin:users:list', 'type' => 3, 'name' => '切换用户状态', 'permission' => 'admin:users:toggle-status', 'route_path' => null, 'component' => null, 'icon' => null, 'sort' => 13],
                ['parent_permission' => 'admin:users:list', 'type' => 3, 'name' => '重置密码', 'permission' => 'admin:users:reset-password', 'route_path' => null, 'component' => null, 'icon' => null, 'sort' => 14],
                ['parent_permission' => 'admin:dashboard:view', 'type' => 2, 'name' => '角色管理', 'permission' => 'admin:roles:list', 'route_path' => '/admin/roles', 'component' => 'features/roles/RoleListPage', 'icon' => 'ShieldCheck', 'sort' => 20],
                ['parent_permission' => 'admin:roles:list', 'type' => 3, 'name' => '新建角色', 'permission' => 'admin:roles:create', 'route_path' => null, 'component' => null, 'icon' => null, 'sort' => 21],
                ['parent_permission' => 'admin:roles:list', 'type' => 3, 'name' => '复制角色', 'permission' => 'admin:roles:copy', 'route_path' => null, 'component' => null, 'icon' => null, 'sort' => 22],
            ...
            foreach ($menuGroups as $menuData) {
                ...
                if (isset($menuData['parent_permission'])) {
                    $parentId = $createdMenus->firstWhere('permission', $menuData['parent_permission'])?->id;
                }
                ...
                $createdMenus->push(Menu::query()->updateOrCreate(
                    ...
                    array_merge($menuData, ['parent_id' => $parentId, 'status' => 1, 'remark' => null])
                ));
            }
