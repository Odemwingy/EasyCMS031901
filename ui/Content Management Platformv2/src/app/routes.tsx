...
// Cycle & Publish Views
import { CycleManageView, SignManageView, ChangeRequestView, PublishStatusView } from "./pages/CyclePublish";

// Report Center Views
import { MediaReportView, ChangeReportView, QualityReportView, OperationReportView } from "./pages/ReportCenter";
  ...
  },
  {
    ...
    children: [
...

      {
        path: "cycle",
        children: [
          { index: true, element: <Navigate to="cycle-manage" replace /> },
          { path: "cycle-manage", element: <CycleManageView /> },
          { path: "sign-manage", element: <SignManageView /> },
          { path: "changes", element: <ChangeRequestView /> },
          { path: "publish-status", element: <PublishStatusView /> },
          { path: "*", element: <PlaceholderView title="周期与发布管理模块" /> }
        ]
      },

      {
        ...
        children: [
          ...
          { path: "media", element: <MediaReportView /> },
          { path: "change", element: <ChangeReportView /> },
          { path: "quality", element: <QualityReportView /> },
          { path: "operation", element: <OperationReportView /> },
          { path: "*", element: <PlaceholderView title="报表中心模块" /> }
        ]
      },
